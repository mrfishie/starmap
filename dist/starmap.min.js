...
function Model(e,t,i,o,s){EventEmitter.call(this),this.io=e,this.name=t,this.url=utils.resolveName(t),this.itemDef=i||{},this.modelDef=o||{},this.filter=s||{},this.children=[],this.eventHandlers={},this.bindings=[],this.value=publicModel(this,new Promise(function(e,t){this.on("ready",e())}.bind(this))),this.on("created",this._onCreated.bind(this)),this.on("updated",this._onUpdated.bind(this)),this.on("destroyed",this._onDestroyed.bind(this)),e.socket.on(t,function(e){console.log(e),this.emit(e.verb,e)}.bind(this)),this.refresh().then(function(){this.emit("ready")}.bind(this))}var Promise=require("bluebird"),_=require("lodash"),utils=require("./utils"),EventEmitter=require("events").EventEmitter,util=require("util"),publicModel=require("./publicModel"),modelItem=require("./modelItem");util.inherits(Model,EventEmitter),module.exports=Model,Model.prototype._addItem=function(e){-1===this.value.indexOf(e)&&this.value.push(e)},Model.prototype._removeItem=function(e){var t=this.value.indexOf(e);-1!==t&&this.value.splice(t,1)},Model.prototype._removeAll=function(){for(;this.value.length;)this.value.pop()},Model.prototype._onCreated=function(e){var t=modelItem(e.data,this);this.childMatches(t).then(function(e){e&&this._addItem(t)}.bind(this))},Model.prototype._onUpdated=function(e){var t=this.value.itemById(e.id);t&&t.update(e.data,!1)},Model.prototype._onDestroyed=function(e){var t=this.value.itemById(e.id);t&&this._removeItem(t)},Model.prototype.childMatches=function(e){return Promise.resolve(function(){return e.model.name!==this.name?!1:_.isEqual(this.filter,{})?!0:e.matches(this.filter)}.bind(this)())},Model.prototype.refresh=function(){return utils.socketGet(this.io,this.url,this.filter).then(function(e){var t=_.isArray(e)?e:[e];this._removeAll();for(var i=0;i<t.length;i++)this._addItem(modelItem(t[i],this))}.bind(this))},Model.prototype.save=function(){_.forEach(this.value,function(e){e.save()})};
...
function update(e,r,t,n){var u=[];return _.forEach(t,function(r,t){_.isFunction(r)?u.push(Promise.resolve(r()).then(function(r){e[t]=r})):e[t]=r}),_.forEach(r.itemDef,function(r,i){if(r&&r.__precalc){console.log("VALUE IS",r,r.__precalc);var o=r.__precalc,a=t[i];u.push(Promise.resolve(o.call(e,a,n||{})).then(function(r){e[i]=r&&r._stWrapped?r.val:r}))}else e[i]=r}),Promise.all(u)}function serverProperties(e,r,t){var n={},u=[];return _.forEach(t||e,function(e,t){e._isModelItem?(n[t]=e.id,u.push(e)):_.isArray(e)?n[t]=_.map(e,function(e){return e._isModelItem?(u.push(e),e.id):e}):_.has(r.itemDef,t)?_.has(r.itemDef[t],"__connection")&&(n[t]=e):n[t]=e}),{properties:n,refresh:u}}function create(e,r,t){var n=serverProperties(e,r,t).properties;return utils.socketPut(r.io,r.url+"/create/",n).then(function(t){return _.merge(n,t),update(e,r,n)}).then(function(){return Promise.all(_.map(n.refresh,function(e){return e.refresh()}))})}function modelItem(e,r){var t={};return utils.defineProperties(t,{_isModelItem:{value:!0},model:{value:r.value},update:{value:function(e,n){return null==n&&(n=!0),update(t,r,e).then(function(){return n?t.save():void 0})}},save:{value:function(){if(_.has(t,"id")){var e=serverProperties(t,r);return utils.socketPost(r.io,r.url+"/update/"+t.id,e.properties).then(function(){return Promise.all(_.map(e.refresh,function(e){return e.refresh()}))})}return create(t,r)}},refresh:{value:function(){return _.has(t,"id")?utils.socketGet(r.io,r.url+"/"+t.id).then(function(e){return update(t,r,e,{noRefresh:!0})}):create(t,r)}},"delete":{value:function(){return r._removeItem(t),utils.socketDelete(r.io,r.url,{id:t.id})}},matches:{value:function(e){return utils.socketGet(r.io,r.url,e).then(function(e){for(var r=0;r<e.length;r++)if(e[r].id===t.id)return!0;return!1})}},then:{value:function(){return t.ready.then.apply(t.ready,arguments)}},"catch":{value:function(){return t.ready["catch"].apply(t.ready,arguments)}}}),t.ready=Promise.resolve(),update(t,r,e||{}),t}var _=require("lodash"),utils=require("./utils"),Promise=require("bluebird");module.exports=modelItem;

},{"./utils":6,"bluebird":7,"lodash":13}],5:[function(require,module,exports){
function publicModel(e,r){function n(r){var n=_.merge({},e.filter,r),t=getModel(e.io,e.name,e.itemDef,e.modelDef,n);return-1===e.children.indexOf(t)&&e.children.push(t),t}function t(e){for(var r=[],n=0;n<u.length;n++)-1!==e.indexOf(u[n].id)&&r.push(u[n]);return r}var u=[];return utils.defineProperties(u,{_isModel:{value:!0},name:{value:e.name},ready:{value:r},create:{value:function(r){r=r||{};var n=modelItem(r,e);return n.ready=n.update(r).then(function(){e._addItem(n)}),n}},itemById:{value:function(e){for(var r=0;r<u.length;r++)if(u[r].id===e)return u[r];return!1}},find:{value:n},filter:{value:n},findOne:{value:function(e){return n(e).then(function(e){return e.length?e[0]:!1})}},refresh:{value:function(){return Promise.all(_.map(u,function(e){return e.refresh()}))}},then:{value:function(){return r.then.apply(r,arguments)}},"catch":{value:function(){return r["catch"].apply(r,arguments)}},__connection:{value:e.name}}),_.merge(u,utils.createCalculateProperty(function(e,n){if(e){var u,i=_.isArray(e);return console.log("Is array? "+i),u=i?_.map(e,function(e){return _.isNumber(e)?e:e.id}):[_.isNumber(e)?e:e.id],r.then(function(){function e(){return i?{_stWrapped:!0,val:r}:{_stWrapped:!0,val:r.length?r[0]:null}}var r=t(u);return console.log(r),n.noRefresh?e():Promise.all(_.map(r,function(e){return e.refresh()})).then(e)}).then(function(e){return console.log("PRECALC",e),e})}}.bind(this))),u}var Promise=require("bluebird"),_=require("lodash"),utils=require("./utils"),getModel=require("./getModel"),modelItem=require("./modelItem");module.exports=publicModel;

},{"./getModel":2,"./modelItem":4,"./utils":6,"bluebird":7,"lodash":13}],6:[function(require,module,exports){
function promisifySocket(e){return function(r,t,o){var n=requestId++;return console.log(n,e.toUpperCase(),t,o),new Promise(function(n,s){r.socket[e](t,o,function(e){e.error?s(e.error):_.isString(e)?s(new Error(e)):n(e)})}).then(function(e){return console.log(n,"OK",e),e},function(e){throw console.log(n,"ERR",e),e})}}var _=require("lodash");exports.resolveName=function(e){var r=e.indexOf("/"),t="";return-1!==r&&(t=e.substring(0,r)+"/",e=e.substring(r+1)),"/"+t+e};var requestId=0;exports.socketGet=promisifySocket("get"),exports.socketPost=promisifySocket("post"),exports.socketPut=promisifySocket("put"),exports.socketDelete=promisifySocket("delete"),exports.defineProperties=function(){return Object.defineProperties?Object.defineProperties:function(e,r){_.extend(e,_.mapValues(r,function(e){return e.value}))}}(),exports.createCalculateProperty=function(e,r){return _.merge({__precalc:e},r)};
